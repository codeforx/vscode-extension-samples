# workbench-state-indicator README

This is the README for your extension "workbench-state-indicator". After writing
up a brief description, we recommend including the following sections.
