...
var yr = (t, e) => {
  for (var r in e) hr(t, r, { get: e[r], enumerable: !0 });
};
var zt = class {
    debug;
    constructor(e = !1) {
    ...
    encoder(e) {
      return new nt(e, this.debug);
    }
    decoder(e) {
      return new st(e, this.debug);
    }
  },
  nt = class {
    w;
    ...
    debug;
    constructor(e, r = !1) {
      this.w = e, this.enc = new TextEncoder(), this.debug = r;
    }
    async encode(e) {
      this.debug && console.log("<<", e);
      let r = this.enc.encode(JSON.stringify(e)), n = 0;
  ...
  st = class {
    ...
    debug;
    constructor(e, r = !1) {
      this.r = e, this.dec = new TextDecoder(), this.debug = r;
    }
    async decode(e) {
      let r = new Uint8Array(e);
      if (await this.r.read(r) === null) return Promise.resolve(null);
      let s = JSON.parse(this.dec.decode(r));
...
var p, ee, f = 0;
var $t = [], pr = 105, mr = 57342, xr = 57343, Nt = 57337;
var Ht = 6,
  ae = {},
  ot = $t,
  at = 0,
  ...
  V,
  we,
  jt = { useRecords: !1, mapsAsObjects: !0 },
  be = !1,
  te = class t {
    constructor(e) {
      if (
        e &&
        ((e.keyMap || e._keyMap) && !e.useRecords &&
          (e.useRecords = !1, e.mapsAsObjects = !0),
          e.useRecords === !1 && e.mapsAsObjects === void 0 &&
          (e.mapsAsObjects = !0),
          e.getStructures && (e.getShared = e.getStructures),
          e.getShared && !e.structures &&
    ...
    decodeKeys(e) {
      ...
      return e.forEach((n, s) =>
        r[v(this._mapKey.has(s) ? this._mapKey.get(s) : s)] = n
      ),
        r;
    }
    mapDecode(e, r) {
    ...
    decode(e, r) {
      if (p) {
        return Xt(
          () => (Oe(),
            this ? this.decode(e, r) : t.prototype.decode.call(jt, e, r)),
        );
      }
      ee = r > -1 ? r : e.length,
        f = 0,
      ...
      try {
        ...
        throw p = null,
          e instanceof Uint8Array ? n : new Error(
...
function D() {
    ...
    switch (t) {
      ...
      case 27:
        ...
        if (e > 1) {
          ...
          t = V.getUint32(f + 4);
        } else {U.int64AsNumber
            ? (t = V.getUint32(f) * 4294967296, t += V.getUint32(f + 4))
            : t = V.getBigUint64(f);}
        f += 8;
        break;
      case 31:
        switch (e) {
          ...
          case 5:
            ...
            if (U.mapsAsObjects) {
              let l = {};
              if (U.keyMap) {
                for (; (o = D()) != ae;) l[v(U.decodeKey(o))] = D();
              } else for (; (o = D()) != ae;) l[v(o)] = D();
              return l;
            } else {
              we && (U.mapsAsObjects = !0, we = !1);
              let l = new Map();
              if (U.keyMap) {
                for (; (o = D()) != ae;) l.set(U.decodeKey(o), D());
  ...
  switch (e) {
    ...
    case 2:
      return br(t);
    case 3:
      if (ge >= f) return Pe.slice(f - ke, (f += t) - ke);
      if (ge == 0 && ee < 140 && t < 32) {
        let s = t < 16 ? Gt(t) : gr(t);
        if (s != null) return s;
      }
      return wr(t);
    case 4:
      let r = new Array(t);
      for (let s = 0; s < t; s++) r[s] = D();
      return r;
    case 5:
      if (U.mapsAsObjects) {
        let s = {};
        if (U.keyMap) {
          for (let o = 0; o < t; o++) s[v(U.decodeKey(D()))] = D();
        } else for (let o = 0; o < t; o++) s[v(D())] = D();
        return s;
      } else {
        we && (U.mapsAsObjects = !0, we = !1);
        let s = new Map();
        if (U.keyMap) {
          for (let o = 0; o < t; o++) s.set(U.decodeKey(D()), D());
        } else for (let o = 0; o < t; o++) s.set(D(), D());
        return s;
      }
    case 6:
      if (t >= Nt) {
        ...
        if (t < 65536) {
          if (t == xr) {
            ...
            return D();
          } else if (t == Nt) return Cr();
          if (U.getShared && (ut(), s = O[t & 8191], s)) {
            return s.read || (s.read = lt(s)), s.read();
          }
        }
      }
      let n = M[t];
  ...
  function e() {
    ...
    if (this.slowReads++ >= 3) {
      ...
      return n = U.keyMap
        ? new Function(
          "r",
          "return {" + o.map((l) => U.decodeKey(l)).map((l) =>
            Kt.test(l) ? v(l) + ":r()" : "[" + JSON.stringify(l) + "]:r()"
          ).join(",") + "}",
        )
        : new Function(
          "r",
...
function ft(t) {
  let e;
  if (t < 16 && (e = Gt(t))) return e;
  if (t > 64 && it) return it.decode(p.subarray(f, f += t));
  let r = f + t, n = [];
  for (e = ""; f < r;) {
    let s = p[f++];
    if (!(s & 128)) n.push(s);
      ...
      let o = p[f++] & 63,
        ...
        g = (s & 7) << 18 | o << 12 | l << 6 | m;
      g > 65535 &&
      (g -= 65536, n.push(g >>> 10 & 1023 | 55296), g = 56320 | g & 1023),
        n.push(g);
    } else n.push(s);
...
function Gt(t) {
  if (t < 4) {
    ...
    if (t < 6) {
      ...
      if (t < 10) {
        if (t === 8) return B(e, r, n, s, o, l, m, g);
        {
          let x = p[f++];
          if ((x & 128) > 0) {
            f -= 9;
        ...
        if (t < 11) return B(e, r, n, s, o, l, m, g, x, k);
        let S = p[f++];
        if ((S & 128) > 0) {
          f -= 11;
          return;
        ...
        if (t < 14) {
          if (t === 12) return B(e, r, n, s, o, l, m, g, x, k, S, F);
          {
            let W = p[f++];
            if ((W & 128) > 0) {
              f -= 13;
          ...
          if (t < 15) return B(e, r, n, s, o, l, m, g, x, k, S, F, W, z);
          let $ = p[f++];
          if (($ & 128) > 0) {
            f -= 15;
            return;
...
function br(t) {
  return U.copyBuffers
    ? Uint8Array.prototype.slice.call(p, f, f += t)
    : p.subarray(f, f += t);
}
var Yt = new Float32Array(1), Ce = new Uint8Array(Yt.buffer, 0, 4);
function Ir() {
  let t = p[f++], e = p[f++], r = (t & 127) >> 2;
  if (r === 31) return e || t & 3 ? NaN : t & 128 ? -1 / 0 : 1 / 0;
  if (r === 0) {
    let n = ((t & 3) << 8 | e) / 16777216;
    return t & 128 ? -n : n;
  }
  return Ce[3] = t & 128 | (r >> 1) + 56,
    Ce[2] = (t & 7) << 5 | e >> 3,
    Ce[1] = e << 5,
    Ce[0] = 0,
    Yt[0];
...
M[0] = (t) => new Date(t);
M[1] = (t) => new Date(Math.round(t * 1e3));
M[2] = (t) => {
  let e = BigInt(0);
...
M[3] = (t) => BigInt(-1) - M[2](t);
M[4] = (t) => +(t[1] + "e" + t[0]);
M[5] = (t) => t[1] * Math.exp(t[0] * Math.log(2));
var dt = (t, e) => {
  t = t - 57344;
  let r = O[t];
  r && r.isShared &&
  ((O.restoreStructures || (O.restoreStructures = []))[t] = r),
    O[t] = e,
    e.read = lt(e);
};
M[pr] = (t) => {
...
M[14] = (t) => R ? R[0].slice(R.position0, R.position0 += t) : new j(t, 14);
M[15] = (t) => R ? R[1].slice(R.position1, R.position1 += t) : new j(t, 15);
var Ar = { Error, RegExp };
M[27] = (t) => (Ar[t[0]] || Error)(t[1], t[2]);
var Jt = (t) => {
  if (p[f++] != 132) {
    throw new Error(
  ...
  let e = t();
  return T = T ? e.concat(T.slice(e.length)) : e,
    T.prefixes = t(),
    T.suffixes = t(),
    t();
};
...
M[Ht] = (t) => {
  if (!T) {
    if (U.getShared) ut();
    else return new j(t, Ht);
  }
  if (typeof t == "number") return T[16 + (t >= 0 ? 2 * t : -2 * t - 1)];
...
M[258] = (t) => new Set(t);
(M[259] = (t) => (U.mapsAsObjects && (U.mapsAsObjects = !1, we = !0), t()))
  .handlesRead = !0;
function ce(t, e) {
...
var Dr = 1399353956;
ct.push((t, e) => {
  if (t >= 225 && t <= 255) return ce(Q().prefixes[t - 224], e);
  if (t >= 28704 && t <= 32767) return ce(Q().prefixes[t - 28672], e);
  if (t >= 1879052288 && t <= 2147483647) {
    return ce(Q().prefixes[t - 1879048192], e);
  }
  if (t >= 216 && t <= 223) return ce(e, Q().suffixes[t - 216]);
  if (t >= 27647 && t <= 28671) return ce(e, Q().suffixes[t - 27639]);
  if (t >= 1811940352 && t <= 1879048191) {
    return ce(e, Q().suffixes[t - 1811939328]);
  }
  if (t == Dr) return { packedValues: T, structures: O.slice(0), version: e };
  if (t == 55799) return e;
});
var Ur = new Uint8Array(new Uint16Array([1]).buffer)[0] == 1,
  ...
  Er = [64, 68, 69, 70, 71, 72, 77, 78, 79, 85, 86];
for (let t = 0; t < qt.length; t++) Sr(qt[t], Er[t]);
function Sr(t, e) {
  ...
  for (let s = 0; s < 2; s++) {
    ...
    M[s ? e : e - 4] = n == 1 || s == Ur
      ? (l) => {
        ...
        return new t(Uint8Array.prototype.slice.call(l, 0).buffer);
      }
      : (l) => {
        if (!t) throw new Error("Could not find typed array for code " + e);
        let m = new DataView(l.buffer, l.byteOffset, l.byteLength),
          g = l.length >> o,
          x = new t(g),
          k = m[r];
...
function ut() {
  if (U.getShared) {
    let t = Xt(() => (p = null, U.getShared())) || {}, e = t.structures || [];
    U.sharedVersion = t.version,
      T = U.sharedValues = t.packedValues,
      O === !0
        ? U.structures = O = e
        : O.splice.apply(O, [0, e.length].concat(e));
  }
}
function Xt(t) {
  let e = ee,
  ...
  return ee = e,
    ...
    O = S,
    U = F,
    V = new DataView(p.buffer, p.byteOffset, p.byteLength),
    z;
}
function Oe() {
...
for (let t = 0; t < 256; t++) Me[t] = +("1e" + Math.floor(45.15 - t * .30103));
var ht = new te({ useRecords: !1 }),
  yt = ht.decode,
  Pr = ht.decodeMultiple,
  Re = { NEVER: 0, ALWAYS: 1, DECIMAL_ROUND: 3, DECIMAL_FIT: 4 };
var _e;
try {
  _e = new TextEncoder();
} catch {}
var Fe,
  bt,
  Ve = globalThis.Buffer,
  Ae = typeof Ve < "u",
  pt = Ae ? Ve.allocUnsafeSlow : Uint8Array,
  Qt = Ae ? Ve : Uint8Array,
  er = 256,
  tr = Ae ? 4294967296 : 2144337920;
var mt,
  a,
  P,
  i = 0,
  ...
  Ie = class extends te {
    constructor(e) {
      ...
      let g = Qt.prototype.utf8Write
          ...
          : !1,
        x = this,
        k = e.structures || e.saveStructures,
        S = e.maxSharedStructures;
      if (S == null && (S = k ? 128 : 0), S > 8190) {
      ...
      this.mapEncode = function (c, y) {
        ...
        this.encode = function (c, y) {
          if (
            a || (a = new pt(8192), P = new DataView(a.buffer, 0, 8192), i = 0),
              Y = a.length - 10,
              Y - i < 2048
                ? (a = new pt(a.length),
                  P = new DataView(a.buffer, 0, a.length),
                  Y = a.length - 10,
                  i = 0)
                : y === gt && (i = i + 7 & 2147483640),
              n = i,
              x.useSelfDescribedHeader && (P.setUint32(i, 3654940416), i += 3),
              m = x.structuredClone ? new Map() : null,
              x.bundleStrings && typeof c != "string"
                ? (_ = [], _.size = 1 / 0)
                : _ = null,
              s = x.structures,
              s
            ...
            if (s.uninitialized) {
              let h = x.getShared() || {};
              x.structures = s = h.structures || [],
                x.sharedVersion = h.version;
            ...
            if (d > S && !F && (d = S), !s.transitions) {
              ...
              for (let h = 0; h < d; h++) {
                ...
                for (let I = 0, A = u.length; I < A; I++) {
                  b[L] === void 0 && (b[L] = h);
                  let E = u[I];
                  w = b[E], w || (w = b[E] = Object.create(null)), b = w;
                }
                b[L] = h | 1048576;
              }
            }
          ...
          if (o && (o = !1), l = s || [], z = N, e.pack) {
            let d = new Map();
            if (
              d.values = [],
                d.encoder = x,
                d.maxValues = e.maxPrivatePackedValues || (N ? 16 : 1 / 0),
                d.objectMap = N || !1,
                d.samplingPackedValues = W,
                Be(c, d),
                d.values.length > 0
            ) {
              a[i++] = 216, a[i++] = 51, q(4);
          ...
          try {
            ...
            if (s) {
              if (Ee < 10 && Ee++, s.length > S && (s.length = S), et > 1e4) {
                s.transitions = null, Ee = 0, et = 0, G.length > 0 && (G = []);
            ...
            if (o && x.saveShared) {
              x.structures.length > S &&
                (x.structures = x.structures.slice(0, S));
              let d = a.subarray(n, i);
              return x.updateSharedData() === !1 ? x.encode(c) : d;
            }
            y & vr && (i = n);
          }
        },
        this.findCommonStringsToPack =
          () => (W = new Map(), N || (N = Object.create(null)), (c) => {
            let y = c && c.threshold || 4,
              d = this.pack ? c.maxPrivatePackedValues || 16 : 0;
            $ || ($ = this.sharedValues = []);
            for (let [h, u] of W) {
              u.count > y && (N[h] = d++, $.push(h), o = !0);
            }
      ...
      let C = (c) => {
          ...
          if (y === "string") {
              ...
              for (b = 0; b < h; b++) {
                I = c.charCodeAt(b),
                  I < 128
                    ? a[E++] = I
                    : I < 2048
                    ? (a[E++] = I >> 6 | 192, a[E++] = I & 63 | 128)
                    : (I & 64512) === 55296 &&
                        ((A = c.charCodeAt(b + 1)) & 64512) === 56320
            ...
            d < 24
              ? a[i++] = 96 | d
              : d < 256
              ? (u < 2 && a.copyWithin(i + 2, i + 1, i + 1 + d),
                a[i++] = 120,
                a[i++] = d)
              : d < 65536
              ? (u < 3 && a.copyWithin(i + 3, i + 2, i + 2 + d),
                a[i++] = 121,
                a[i++] = d >> 8,
                a[i++] = d & 255)
              : (u < 5 && a.copyWithin(i + 5, i + 3, i + 3 + d),
                a[i++] = 122,
                P.setUint32(i, d),
                i += 4), i += d;
          } else if (y === "number") {
            if (!this.alwaysUseFloat && c >>> 0 === c) {
              c < 24
                ...
                ? (a[i++] = 24, a[i++] = c)
                : c < 65536
                ? (a[i++] = 25, a[i++] = c >> 8, a[i++] = c & 255)
                : (a[i++] = 26, P.setUint32(i, c), i += 4);
              ...
              c >= -24
                ...
                ? (a[i++] = 56, a[i++] = ~c)
                : c >= -65536
                ? (a[i++] = 57, P.setUint16(i, ~c), i += 2)
                : (a[i++] = 58, P.setUint32(i, ~c), i += 4);
            } else {
              let h;
              if (
                (h = this.useFloat32) > 0 && c < 4294967296 && c >= -2147483648
              ) {
                a[i++] = 250, P.setFloat32(i, c);
                let u;
                if (
                  h < 4 ||
                  (u = c * Me[(a[i] & 127) << 1 | a[i + 1] >> 7]) >> 0 === u
                ) {
                  i += 4;
                  return;
                } else i--;
            ...
            if (!c) a[i++] = 246;
              ...
              if (h === Object) tt(c, !0);
                ...
                if (
                  ...
                  (a[i++] = 217, a[i++] = 1, a[i++] = 3),
                    ...
                    d < 24
                      ...
                      ? (a[i++] = 184, a[i++] = d)
                      : d < 65536
                      ? (a[i++] = 185, a[i++] = d >> 8, a[i++] = d & 255)
                      : (a[i++] = 186, P.setUint32(i, d), i += 4),
                    x.keyMap
                ) { for (let [u, w] of c) C(x.encodeKey(u)), C(w); } else {for (
                    let [u, w] of c
                  ) C(u), C(w);}
              } else {
                for (let u = 0, w = Fe.length; u < w; u++) {
                  ...
                  if (c instanceof b) {
                    let I = Fe[u], A = I.tag;
                    A == null && (A = I.getTag && I.getTag.call(this, c)),
                      A < 24
                        ? a[i++] = 192 | A
                        : A < 256
                        ? (a[i++] = 216, a[i++] = A)
                        : A < 65536
                        ? (a[i++] = 217, a[i++] = A >> 8, a[i++] = A & 255)
                        : A > -1 && (a[i++] = 218, P.setUint32(i, A), i += 4),
                      I.encode.call(this, c, C, me);
                    return;
                  }
                }
            ...
            if (c < BigInt(1) << BigInt(64) && c >= 0) {
              a[i++] = 27, P.setBigUint64(i, c);
            } else if (c > -(BigInt(1) << BigInt(64)) && c < 0) {
              a[i++] = 59, P.setBigUint64(i, -c - BigInt(1));
            } else if (this.largeBigIntToFloat) {
              a[i++] = 251, P.setFloat64(i, Number(c));
          ...
          ? this.variableMapSize
            ? (c) => {
              ...
              h < 24
                ...
                ? (a[i++] = 184, a[i++] = h)
                : h < 65536
                ? (a[i++] = 185, a[i++] = h >> 8, a[i++] = h & 255)
                : (a[i++] = 186, P.setUint32(i, h), i += 4);
              let u;
              if (x.keyMap) {
                for (let w = 0; w < h; w++) C(encodeKey(y[w])), C(d[w]);
            ...
            : (c, y) => {
              ...
              if (x.keyMap) {
                for (let u in c) {
                  (y || c.hasOwnProperty(u)) &&
                    (C(x.encodeKey(u)), C(c[u]), h++);
                }
              } else {for (let u in c) {
                  (y || c.hasOwnProperty(u)) && (C(u), C(c[u]), h++);
                }}
              a[d++ + n] = h >> 8, a[d + n] = h & 255;
            }
          : (c, y) => {
            let d,
              h = l.transitions || (l.transitions = Object.create(null)),
              u = 0,
              w = 0,
              b,
              I;
            if (this.keyMap) {
              ...
              for (let E = 0; E < w; E++) {
                let vt = I[E];
                d = h[vt], d || (d = h[vt] = Object.create(null), u++), h = d;
              }
            } else {for (let E in c) {
                (y || c.hasOwnProperty(E)) &&
                  (d = h[E],
                    d ||
                    (h[L] & 1048576 && (b = h[L] & 65535),
                      d = h[E] = Object.create(null),
                      u++),
                    h = d,
                    w++);
              }}
            ...
            if (A !== void 0) {
              ...
              I || (I = h.__keys__ || (h.__keys__ = Object.keys(c))),
                b === void 0
                  ? (A = l.nextId++,
                    A || (A = 0, l.nextId = 1),
                    A >= er && (l.nextId = (A = S) + 1))
              ...
              a[i++] = 217,
                ...
                h = l.transitions;
              for (let E = 0; E < w; E++) {
                (h[L] === void 0 || h[L] & 1048576) && (h[L] = A), h = h[I[E]];
              }
              h[L] = A | 1048576, o = !0;
            } else {
              if (
                h[L] = A,
                  P.setUint32(i, 3655335680),
                  i += 3,
                  u && (et += Ee * u),
                  G.length >= er - S && (G.shift()[L] = void 0),
                  G.push(h),
                  q(w + 2),
                  C(57344 + A),
                  C(I),
            ...
            if (w < 24 ? a[i++] = 128 | w : q(w), y !== null) {
              for (let E in c) {
                (y || c.hasOwnProperty(E)) && C(c[E]);
              }
            }
          },
        me = (c) => {
          ...
          if (c > 16777216) {
            ...
            y = Math.min(
              tr,
              Math.round(
                Math.max((c - n) * (c > 67108864 ? 1.25 : 2), 4194304) / 4096,
              ) * 4096,
            );
          } else y = (Math.max(c - n << 2, a.length - 1) >> 12) + 1 << 12;
          let d = new pt(y);
          return P = new DataView(d.buffer, 0, y),
            a.copy ? a.copy(d, 0, n, c) : d.set(a.slice(n, c)),
            i -= n,
            n = 0,
            Y = d.length - 10,
            a = d;
      ...
      function* oe(c, y, d) {
        let h = c.constructor;
        if (h === Object) {
          let u = x.useRecords !== !1;
          u ? tt(c, null) : rr(Object.keys(c).length, 160);
          for (let w in c) {
            let b = c[w];
            u || C(w),
              b && typeof b == "object"
                ? y[w] ? yield* oe(b, y[w]) : yield* rt(b, y, w)
                : C(b);
          }
        } else if (h === Array) {
          let u = c.length;
          ...
          for (let w = 0; w < u; w++) {
            let b = c[w];
            b && (typeof b == "object" || i - n > Z)
              ? y.element ? yield* oe(b, y.element) : yield* rt(b, y, "element")
              : C(b);
          }
        } else if (c[Symbol.iterator]) {
          a[i++] = 159;
          for (let u of c) {
            u && (typeof u == "object" || i - n > Z)
              ? y.element ? yield* oe(u, y.element) : yield* rt(u, y, "element")
              : C(u);
          }
          a[i++] = 255;
        } else {xt(c)
            ? (rr(c.size, 64), yield a.subarray(n, i), yield c, xe())
            : c[Symbol.asyncIterator]
            ? (a[i++] = 159,
              yield a.subarray(n, i),
              yield c,
              xe(),
              a[i++] = 255)
            : C(c);}
      ...
      function* rt(c, y, d) {
        ...
        try {
          ...
          if (u.iteratorNotHandled) {
            y[d] = {}, i = n + h, yield* oe.call(this, c, y[d]);
          } else throw u;
        }
      }
      function xe() {
      ...
      function Tt(c, y, d) {
        return y && y.chunkThreshold ? Z = Vt = y.chunkThreshold : Z = 100,
          c && typeof c == "object"
            ? (x.encode(null, wt),
              d(c, x.iterateProperties || (x.iterateProperties = {}), !0))
            : [x.encode(c)];
      }
      async function* Lt(c, y) {
        for (let d of oe(c, y, !0)) {
          let h = d.constructor;
          if (h === Qt || h === Uint8Array) yield d;
            ...
            for await (let u of d) {
              xe(),
                u ? yield* Lt(u, y.async || (y.async = {})) : yield x.encode(u);
            }
          } else yield d;
        }
      }
    ...
    updateSharedData() {
      ...
      let r = this.structures.slice(0),
        n = new We(r, this.sharedValues, this.sharedVersion),
        s = this.saveShared(n, (o) => (o && o.version || 0) == e);
      return s === !1
        ? (n = this.getShared() || {},
        ...
        : r.forEach((o, l) => this.structures[l] = o),
        s;
    }
  };
function rr(t, e) {
  t < 24
    ...
    ? (a[i++] = e | 24, a[i++] = t)
    : t < 65536
    ? (a[i++] = e | 25, a[i++] = t >> 8, a[i++] = t & 255)
    : (a[i++] = e | 26, P.setUint32(i, t), i += 4);
}
var We = class {
  constructor(e, r, n) {
...
function q(t) {
  t < 24
    ...
    ? (a[i++] = 152, a[i++] = t)
    : t < 65536
    ? (a[i++] = 153, a[i++] = t >> 8, a[i++] = t & 255)
    : (a[i++] = 154, P.setUint32(i, t), i += 4);
}
var Mr = typeof Blob > "u" ? function () {} : Blob;
function xt(t) {
  if (t instanceof Mr) return !0;
  ...
  switch (typeof t) {
    case "string":
      if (t.length > 3) {
        ...
        let n = e.get(t);
        if (n) ++n.count == 2 && e.values.push(t);
    ...
    case "object":
      if (t) {
        if (t instanceof Array) {
          for (let n = 0, s = t.length; n < s; n++) Be(t[n], e);
        } else {
          let n = !e.encoder.useRecords;
          for (var r in t) {
            t.hasOwnProperty(r) && (n && Be(r, e), Be(t[r], e));
          }
        }
      }
      break;
...
Fe = [
  {
    ...
    encode(t, e) {
      let r = t.getTime() / 1e3;
      (this.useTimestamp32 || t.getMilliseconds() === 0) && r >= 0 &&
        r < 4294967296
        ? (a[i++] = 26, P.setUint32(i, r), i += 4)
        : (a[i++] = 251, P.setFloat64(i, r), i += 8);
    },
  },
  {
    tag: 258,
  ...
  },
  {
    getTag(t) {
      if (
        ...
        (this.tagUint8Array || Ae && this.tagUint8Array !== !1)
      ) return 64;
    },
    encode(t, e, r) {
      nr(t, r);
  ...
  K(86, 8),
  {
    encode(t, e) {
      ...
      if (n) {
        ...
        let s = n.slice(0);
        s.unshift(57344), s.push(new j(t.version, 1399353956)), e(s);
      } else e(new j(t.version, 1399353956));
    },
  },
];
function K(t, e) {
...
function nr(t, e) {
  ...
  r < 24
    ...
    ? (a[i++] = 88, a[i++] = r)
    : r < 65536
    ? (a[i++] = 89, a[i++] = r >> 8, a[i++] = r & 255)
    : (a[i++] = 90, P.setUint32(i, r), i += 4),
    i + r >= a.length && e(i + r),
    a.set(t.buffer ? t : new Uint8Array(t), i),
    i += r;
}
function _r(t, e) {
  ...
  for (let o = 0; o < e.length; o++) {
    let l = e[o];
    l.id = o;
    for (let m of l.references) t[m++] = o >> 8, t[m] = o & 255;
  }
  for (; r = e.pop();) {
    let o = r.offset;
...
function sr(t, e) {
  P.setUint32(_.position + t, i - _.position - t + 1);
  let r = _;
  _ = null, e(r[0]), e(r[1]);
}
function It(t) {
  if (t.Class) {
    ...
    bt.unshift(t.Class), Fe.unshift(t);
  }
  Zt(t);
}
var At = new Ie({ useRecords: !1 }),
  Dt = At.encode,
  Br = At.encodeAsIterable,
  Fr = At.encodeAsAsyncIterable,
  { NEVER: Wr, ALWAYS: Vr, DECIMAL_ROUND: Tr, DECIMAL_FIT: Lr } = Re,
  gt = 512,
  vr = 1024,
  wt = 2048;
var ir = class {
...
var Le = 32 * 1024,
  ...
  ve = class {
    ...
    _off;
    constructor(e) {
      this._buf = e === void 0 ? new Uint8Array(0) : new Uint8Array(e),
        this._off = 0;
    }
    bytes(e = { copy: !0 }) {
      return e.copy === !1
    ...
    _grow(e) {
      ...
      if (e <= Math.floor(s / 2) - r) {
        Te(this._buf.subarray(this._off), this._buf);
      } else {
        if (s + e > St) {
          throw new Error(
    ...
    async readFrom(e) {
      ...
      for (;;) {
        let s = this.capacity - this.length < Le,
          o = s ? n : new Uint8Array(this._buf.buffer, this.length),
          l = await e.read(o);
        if (l === null) return r;
        s ? this.writeSync(o.subarray(0, l)) : this._reslice(this.length + l),
          r += l;
      }
    }
    readFromSync(e) {
...
var de = class {
  ...
  async call(e, r) {
    ...
    try {
      ...
      return g.value = await l.decode(),
        g.continue = m.C,
        g.continue || await n.close(),
        g;
    } catch (s) {
...
function ar(t) {
  function e(r, n) {
    return new Proxy(Object.assign(() => {}, { path: r, callable: n }), {
      get(s, o, l) {
        return o.startsWith("__")
          ? Reflect.get(s, o, l)
          : e(s.path ? `${s.path}.${o}` : o, s.callable);
      },
      apply(s, o, l = []) {
...
function kt(t) {
  return t === ""
    ? "/"
    : (t[0] != "/" && (t = "/" + t), t = t.replace(".", "/"), t.toLowerCase());
}
var J = class {
  handlers;
  constructor() {
  ...
  match(e) {
    ...
    for (let n of r) {
      if (e.startsWith(n)) {
        ...
        return o.match && o.match instanceof Function
          ? o.match(e.slice(n.length))
          : s;
      }
    }
    return null;
  ...
  handle(e, r) {
    ...
    let n = kt(e), s = r;
    if (
      s.match && s.match instanceof Function && !n.endsWith("/") &&
      (n = n + "/"), !r
...
async function cr(t, e, r) {
  let n = new fe(e),
    ...
    o = await s.decode(),
    l = new Ne(o.S, t, s);
  l.caller = new de(t.session, e);
  let m = new He(), g = new Ot(t, n, m);
  return r || (r = new J()),
    await r.respondRPC(g, l),
    g.responded || await g.return(null),
    Promise.resolve();
}
var Ot = class {
  header;
  ...
  responded;
  constructor(e, r, n) {
    this.ch = e, this.codec = r, this.header = n, this.responded = !1;
  }
  send(e) {
    return this.codec.encoder(this.ch).encode(e);
  }
  return(e) {
    return this.respond(e, !1);
  }
  async continue(e) {
    return await this.respond(e, !0), this.ch;
  }
  async respond(e, r) {
    return this.responded = !0,
      this.header.C = r,
      e instanceof Error && (this.header.E = e.message, e = null),
      await this.send(this.header),
      await this.send(e),
      r || await this.ch.close(),
      Promise.resolve();
  }
};
var Ne = class {
  ...
  ze = class {
    ...
    codec;
    constructor(e, r) {
      this.channel = e, this.codec = r, this.error = void 0, this.continue = !1;
    }
    send(e) {
...
var je = class {
  ...
  constructor(e, r) {
    this.session = e,
      this.codec = r,
      this.caller = new de(e, r),
      this.responder = new J();
  }
  close() {
...
function Hr(t) {
  if (t.ID === 106) {
    ...
    return r.setUint8(0, e.ID),
      r.setUint32(1, e.channelID),
  ...
  if (t.ID === 100) {
    ...
    return r.setUint8(0, e.ID),
      r.setUint32(1, e.senderID),
      r.setUint32(5, e.windowSize),
      r.setUint32(9, e.maxPacketSize),
      new Uint8Array(r.buffer);
  }
  if (t.ID === 101) {
    ...
    return r.setUint8(0, e.ID),
      r.setUint32(1, e.channelID),
      r.setUint32(5, e.senderID),
      r.setUint32(9, e.windowSize),
      r.setUint32(13, e.maxPacketSize),
      new Uint8Array(r.buffer);
  }
  if (t.ID === 102) {
    let e = t, r = new DataView(new ArrayBuffer(5));
  ...
  if (t.ID === 103) {
    ...
    return r.setUint8(0, e.ID),
      r.setUint32(1, e.channelID),
      r.setUint32(5, e.additionalBytes),
      new Uint8Array(r.buffer);
  }
...
var pe = class {
  ...
  $e = class {
    ...
    read(e) {
      return new Promise((r) => {
        let n = () => {
          ...
          this.readBuf = this.readBuf.slice(s.length),
            this.readBuf.length == 0 && this.gotEOF && (this.readBuf = void 0),
            e.set(s),
            r(s.length);
        };
        n();
    ...
    write(e) {
      for (
        this.readBuf &&
        (this.readBuf = Ge([this.readBuf, e], this.readBuf.length + e.length));
...
async function jr(t) {
  ...
  if (await t.read(e) === null) return Promise.resolve(null);
  let n = e[0], s = lr.get(n);
  if (s === void 0 || n < 100 || n > 106) {
  ...
  if (n === 104) {
    ...
    for (; x < g;) {
      let S = new Uint8Array(g - x), F = await t.read(S);
      if (F === null) {
...
function Kr(t) {
  ...
  switch (t[0]) {
    ...
    case 100:
      return {
        ID: t[0],
        senderID: e.getUint32(1),
        windowSize: e.getUint32(5),
        maxPacketSize: e.getUint32(9),
      };
    case 101:
      return {
        ID: t[0],
        channelID: e.getUint32(1),
        senderID: e.getUint32(5),
        windowSize: e.getUint32(9),
        maxPacketSize: e.getUint32(13),
      };
    case 102:
      return { ID: t[0], channelID: e.getUint32(1) };
    case 103:
      return {
        ID: t[0],
        channelID: e.getUint32(1),
        additionalBytes: e.getUint32(5),
      };
    default:
      throw `unmarshal of unknown type: ${t[0]}`;
  }
}
var ue = { messages: !1, bytes: !1 };
var Rt = 9,
  _t = Number.MAX_VALUE,
  Je = class {
    conn;
    ...
    async open() {
      ...
      if (
        e.maxIncomingPayload = Xe,
          await this.enc.encode({
            ID: 100,
            windowSize: e.myWindow,
            maxPacketSize: e.maxIncomingPayload,
            senderID: e.localId,
          }),
          await e.ready.shift()
      ) return e;
    ...
    async close() {
      ...
      this.conn.close(), this.closed = !0, await this.done;
    }
    async loop() {
      try {
        for (;;) {
    ...
    async handleOpen(e) {
      ...
      r.remoteId = e.senderID,
        r.maxRemotePayload = e.maxPacketSize,
        r.remoteWin = e.windowSize,
        r.maxIncomingPayload = Xe,
        this.incoming.push(r),
        await this.enc.encode({
          ID: 101,
          channelID: r.remoteId,
          senderID: r.localId,
          windowSize: r.myWindow,
          maxPacketSize: r.maxIncomingPayload,
        });
    }
    newChannel() {
      let e = new Ze(this);
    ...
    getCh(e) {
      ...
      return r && r.localId !== e &&
        console.log("bad ids:", e, r.localId, r.remoteId),
        r;
    }
    addCh(e) {
...
var Xe = 1 << 24,
  ...
  Ze = class {
      ...
      return this.sentEOF ? Promise.reject("EOF") : new Promise((r, n) => {
        let s = 0,
          o = () => {
            ...
            let l = Math.min(this.maxRemotePayload, e.length),
              m = this.reserveWindow(l);
            if (m == 0) {
              this.writers.push(o);
              return;
            }
    ...
    async closeWrite() {
      this.sentEOF = !0,
        await this.send({ ID: 105, channelID: this.remoteId }),
        this.writers.forEach((e) => e()),
        this.writers = [];
    }
    async close() {
      if (this.readBuf.eof(), !this.sentClose) {
        for (
          await this.send({ ID: 106, channelID: this.remoteId }),
            this.sentClose = !0;
          await this.ready.shift() !== null;
        );
        return;
      }
      this.shutdown();
    ...
    handle(e) {
      ...
      if (e.ID === 105 && this.readBuf.eof(), e.ID === 102) {
        this.session.rmCh(e.channelID), this.ready.push(!1);
        return;
      }
      if (e.ID === 101) {
        if (e.maxPacketSize < Rt || e.maxPacketSize > _t) {
        ...
        this.remoteId = e.senderID,
          this.maxRemotePayload = e.maxPacketSize,
          this.addWindow(e.windowSize),
          this.ready.push(!0);
        return;
      }
...
var Qe = class {
  ...
  close() {
    this.isClosed ||
      (this.isClosed = !0, this.waiters.forEach((e) => e()), this.ws.close());
  }
};
var Gr = { transport: Bt };
async function jn(t, e) {
  let r = await Gr.transport.connect(t);
  return Yr(r, e);
}
function Yr(t, e, r) {
  let n = new Je(t), s = new je(n, e);
  if (r) {
    for (let o in r) s.handle(o, Ue(r[o]));
    s.respond();
  }
  return s;
}
function $n(t) {
  return t instanceof Function ? ur(t) : Jr(t);
}
function Jr(t) {
  let e = new J();
  for (let r of Xr(t)) {
    if (!(["constructor", "respondRPC"].includes(r) || r.startsWith("_"))) {
      if (t[r] instanceof Function) {
        let n = ur(t[r], t);
        t[`_${r}RPC`] instanceof Function &&
        (n = { respondRPC: t[`_${r}RPC`].bind(t) }), e.handle(r, n);
      } else t[r] && t[r].respondRPC && e.handle(r, t[r]);
    }
  }
  return t.respondRPC && e.handle("/", t), e;
}
function ur(t, e) {
  return Ue(async (r, n) => {
    try {
      let s = t.apply(e, await n.receive());
...
function Xr(t) {
  let e = new Set();
  Object.getOwnPropertyNames(t).forEach((r) => e.add(r));
  for (let r = t; r != null; r = Object.getPrototypeOf(r)) {
    r.constructor.name !== "Object" &&
      Object.getOwnPropertyNames(r).forEach((n) => e.add(n));
  }
  return [...e];
}
function Yn(t) {
...
async function ts(t, e) {
  let r = new Uint8Array(32768), n = 0;
  for (;;) {
    let s = await e.read(r);
    if (s === null) break;
    n += await t.write(r.subarray(0, s));
  }
  return n;
}
var Ft = class {
  ...
  close() {
    this.isClosed ||
      (this.isClosed = !0, this.waiters.forEach((e) => e()), this.port.close());
  }
};
var Wt = class {
  worker;
  ...
  constructor(e) {
    this.isClosed = !1,
      ...
      this.worker.onmessage = (r) => {
        if (!r.data.duplex) return;
        let n = new Uint8Array(r.data.duplex);
        if (this.chunks.push(n), this.waiters.length > 0) {
          let s = this.waiters.shift();
          s && s();
        }
  ...
  write(e) {
    return this.worker.postMessage({ duplex: e.buffer }),
      Promise.resolve(e.byteLength);
  }
  close() {
    this.isClosed || (this.isClosed = !0, this.waiters.forEach((e) => e()));
  }
};
export {
  $n as handlerFrom,
  _t as maxPacketLength,
  ar as VirtualCaller,
  cr as Respond,
  Ct as FrameEncoder,
  de as Client,
  ...
  ve as Buffer,
  Wt as WorkerConn,
  Xe as channelMaxPacket,
  Yn as methodProxy,
  Yr as open,
  Ze as Channel,
  ze as Response,
  zr as NotFoundHandler,
  zt as JSONCodec,
};
